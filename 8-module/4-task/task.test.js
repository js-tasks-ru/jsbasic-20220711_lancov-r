    ...
    describe("отправка формы заказа", () => {
      ...
      describe("если отправка успешная", () => {
        ...
        it("должна отображать текст о размещении заказа", async function (done) {
          ...
          let isOrderSuccessfull =
            modalInnerP.textContent.indexOf("Order successful!") !== -1;
      ...
      describe("увеличение на единицу", () => {
        beforeEach(() => {
          ...
          let plusButton = document.querySelector(
            `[data-product-id="${productId}"] .cart-counter__button_plus`
          );
      ...
      describe("уменьшение на единицу", () => {
        ...
        beforeEach(() => {
          ...
          minusButton = document.querySelector(
            `[data-product-id="${productId}"] .cart-counter__button_minus`
          );
        ...
        it("должна закрывать модальное окно если товаров в корзине не осталось", () => {
          ...
          let minusButton2 = document.querySelector(
            `[data-product-id="${products[1].id}"] .cart-counter__button_minus`
          );
